...
U.friendly_name AS "Friendly Name", P.name as "Object Name", P.name as "Project", NULL as "Workbook", NULL as "View"
...
) ALP ON UGP."Is _users.id/groups.id" = ALP.system_users.id
